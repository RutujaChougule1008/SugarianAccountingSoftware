...
const SugarPurchase = () => {
  ...
  const handleMatchStatus = (match_status, subTotal) => {
    ...
    if (match_status === "TRUE") {
      ...
      setFormData({
        ...
        IGSTRate: 0.0, // Reset IGST rate
        CGSTAmount: cgstAmount,
        SGSTAmount: sgstAmount,
        IGSTAmount: 0.0, // Reset IGST amount
      ...
      setFormData({
        ...formData,
        CGSTRate: 0.0, // Reset CGST rate
        SGSTRate: 0.0, // Reset SGST rate
        IGSTRate: igstRate.toFixed(2), // Convert rate to string with 2 decimal places
        CGSTAmount: 0.0, // Reset CGST amount
        SGSTAmount: 0.0,
  ...
  const handleGstCode = async (code, Rate) => {
    ...
    if (from != "" || FromCode != "") {
      ...
      const response = await axios.get(
        `http://localhost:8080/api/sugarian/get_match_status`,
        {
          params: {
            Company_Code: companyCode,
            Year_Code: Year_Code,
    ...
    <>
      ...
      <form className="debitCreditNote-container" onSubmit={handleSubmit}>
        <div className="debitCreditNote-row">
          ...
          <label htmlFor="DO_No" className="debitCreditNote-form-label">
            Do No:
          </label>
          ...
          <label htmlFor="Retail_Stock" className="debitCreditNote-form-label">
            Retail Stock:
          </label>
          <div className="debitCreditNote-col">
          ...
          <label htmlFor="From" className="debitCreditNote-form-label">
            From:
          </label>
          <div className="debitCreditNote-col">
            <div className="debitCreditNote-form-group">
        ...
        <div className="debitCreditNote-row">
          <label htmlFor="Unit" className="debitCreditNote-form-label">
            Unit:
          </label>
          <div className="debitCreditNote-col">
            <div className="debitCreditNote-form-group">
        ...
        <div className="debitCreditNote-row">
          ...
          <div className="debitCreditNote-col-Text">
            <div className="debitCreditNote-form-group">
              ...
              />
              {formErrors.subTotal && (
                <span className="error">{formErrors.subTotal}</span>
              )}
            </div>
          </div>
          ...
          <div className="debitCreditNote-col-Text">
            <div className="debitCreditNote-form-group">
              ...
              />
              {formErrors.CGSTRate && (
                <span className="error">{formErrors.CGSTRate}</span>
              )}
              <input
                tabIndex="15"
                type="text"
                ...
                disabled={!isEditing && addOneButtonEnabled}
              />
              {formErrors.CGSTAmount && (
                <span className="error">{formErrors.CGSTAmount}</span>
              )}
            </div>
          </div>
          ...
          <div className="debitCreditNote-col-Text">
            <div className="debitCreditNote-form-group">
              ...
              />
              {formErrors.SGSTRate && (
                <span className="error">{formErrors.SGSTRate}</span>
              )}
              <input
                tabIndex="17"
                type="text"
                ...
                disabled={!isEditing && addOneButtonEnabled}
              />
              {formErrors.SGSTAmount && (
                <span className="error">{formErrors.SGSTAmount}</span>
              )}
            </div>
          </div>
          ...
          <div className="debitCreditNote-col-Text">
            <div className="debitCreditNote-form-group">
              ...
              />
              {formErrors.IGSTRate && (
                <span className="error">{formErrors.IGSTRate}</span>
              )}
              <input
                tabIndex="19"
                type="text"
                ...
                disabled={!isEditing && addOneButtonEnabled}
              />
              {formErrors.IGSTAmount && (
                <span className="error">{formErrors.IGSTAmount}</span>
              )}
            </div>
          </div>
          ...
          <div className="debitCreditNote-col-Text">
            <div className="debitCreditNote-form-group">
              <input
                ...
                disabled={!isEditing && addOneButtonEnabled}
              />
              {formErrors.LESS_FRT_RATE && (
                <span className="error">{formErrors.LESS_FRT_RATE}</span>
              )}
              <input
                tabIndex="19"
                type="text"
              ...
              />
              {formErrors.freight && (
                <span className="error">{formErrors.freight}</span>
              )}
            </div>
          </div>
          ...
          <div className="debitCreditNote-col-Text">
            <div className="debitCreditNote-form-group">
              <input
                ...
                disabled={!isEditing && addOneButtonEnabled}
              />
              {formErrors.bank_commission && (
                <span className="error">{formErrors.bank_commission}</span>
              )}
            </div>
          </div>
          ...
          <div className="debitCreditNote-col-Text">
            <div className="debitCreditNote-form-group">
              <input
                ...
                disabled={!isEditing && addOneButtonEnabled}
              />
              {formErrors.OTHER_AMT && (
                <span className="error">{formErrors.OTHER_AMT}</span>
              )}
            </div>
          </div>
          ...
          <div className="debitCreditNote-col-Text">
            <div className="debitCreditNote-form-group">
              <input
                ...
                disabled={!isEditing && addOneButtonEnabled}
              />
              {formErrors.cash_advance && (
                <span className="error">{formErrors.cash_advance}</span>
              )}
            </div>
          </div>
